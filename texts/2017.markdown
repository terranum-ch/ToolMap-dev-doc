...
Depuis le répertoire `bin` lancez la commande suivante :
 ...
 1. pour avoir le support pour les tests unitaires il faut rajouter la commande ci-dessous avant les ".." :
...
1. pour utiliser tout les coeurs lors de la compilation sous Visual Studio il faut ajouter après "set WXWIN" :
